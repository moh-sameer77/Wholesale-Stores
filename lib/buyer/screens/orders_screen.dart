...
class _OrdersScreenState extends State<OrdersScreen> {
  List orders =[];
  late OrdersList ordersList;
  @override
  void initState() {
    // TODO: implement initState
    ordersList = Provider.of<OrdersList>(context, listen: false);
    getAll();
    super.initState();
  }

  void getAll() async{
    ResponseContainer responseContainer =  await getAllOrdersByBuyer();
  ...
  Consumer<OrdersList> ListviewMade() {
